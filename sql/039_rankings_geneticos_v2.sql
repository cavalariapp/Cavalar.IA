-- 039 — RANKINGS GENÉTICOS v2: números SEPARADOS + % com denominador correto
-- Por reprodutor (papel='pai'/'mae'), com filtro de ano da prova (NULL = todos):
--   total_filhos : filhos registrados (ABCCH)
--   f4           : filhos com +4 anos (idade atual; vivos, <=30)
--   comp         : filhos competindo (qualquer idade)
--   pct_comp     : % dos filhos +4 anos que competem  =  (+4 E competindo) / f4
--   f8           : filhos com +8 anos
--   m140         : filhos saltando >= 1,40 m (qualquer idade)
...
set statement_timeout = '25s' as $$
  ...
  ev as (   -- por filho competidor (no filtro de ano): idade + maior altura
